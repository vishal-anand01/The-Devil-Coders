...
const HRDepartmentJob = () => {
    useEffect(() => {
        initializeTypewriter([
            { elementId: 'app', text: 'HR Department' },
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/careerHRDepartmentJob', formDataToSubmit, {
                headers: {
    ...
    return (
        <div>
            ...
            <Helmet>
                {/* Title */}
                <title>Career - HR Department | Crew Captivators Solutions Pvt. Ltd.</title>
                {/* Meta description */}
                <meta
                    name="description"
                    content="Join the HR Department at Crew Captivators Solutions Pvt. Ltd. and become a vital part of our team dedicated to nurturing talent, fostering a positive workplace culture, and driving organizational success through strategic HR initiatives and people-centric approaches..."
                />
                {/* Other meta tags */}
                        ...
                        <div className="col-lg-8">
                            <div className="d-flex align-items-center mb-5">
                                ...
                                <div className="text-start ps-4">
                                    <h3 className="mb-3">HR Department</h3>
                            ...
                            <div className="mb-5">
                                ...
                                <p>
                                    The Human Resources (HR) Department is responsible for managing various aspects of an organization's human capital, including recruitment, employee relations, performance management, training and development, compensation and benefits, and compliance with labor laws and regulations. HR professionals play a crucial role in fostering a positive work environment, supporting employee well-being, and aligning HR strategies with organizational goals.</p>

                                <h4 className="mb-3">Responsibility</h4>
                                <p>The HR Department oversees various aspects of human capital management, including recruitment, employee relations, performance management, training, and compliance, ensuring a positive work environment and alignment with organizational goals.</p>
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Recruitment and Onboarding</li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Employee Relations</li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Performance Management
                                    </li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Training and Development</li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Compliance and Policy Enforcement
                                    </li>
                                </ul>
                                <h4 class="mb-3">Qualifications</h4>
                                <p>Professionals in HR typically possess a bachelor's degree in human resources, business administration, or a related field, along with strong interpersonal skills and a thorough understanding of HR principles and practices.</p>
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>HR Knowledge
                                    </li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>HRIS Proficiency</li>
                                    <li><i class="fa fa-angle-right text-primary me-2"></i>Certification
                                    </li>
                                </ul>
                            </div>
                            <div className="">
...
export default HRDepartmentJob;
